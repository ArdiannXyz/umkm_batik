  ...
  Future<void> _sendMessage(String message) async {
    ...
    try {
      ...
      final response = await http.post(
        Uri.parse('http://192.168.231.254/umkm_batik/API/chatbot_api.php'),
      ...
      if (responseData['type'] == 'stock_steps' || 
        ...
        if (responseData.containsKey('data') && responseData['data'].isNotEmpty) {
          for (var product in responseData['data']) {
            ...
            content += "  Status: ${product['status'] == 'available' ? 'Tersedia' : 'Tidak Tersedia'}\n\n";
          }
        }
                ...
                if (menu != null && menu!.isNotEmpty) ...[
                  ...
                  ...menu!.map((item) => GestureDetector(
                    onTap: () {
                      ...
                      final chatbotState = context.findAncestorStateOfType<_PanduanChatbotState>();
